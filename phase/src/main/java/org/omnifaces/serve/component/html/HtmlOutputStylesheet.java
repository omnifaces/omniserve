...
/**
 * An HTML output stylesheet.
 */
@ServeComponent(value = "org.omnifaces.serve.component.html.HtmlOutputStylesheet")
public class HtmlOutputStylesheet extends UIOutput {
