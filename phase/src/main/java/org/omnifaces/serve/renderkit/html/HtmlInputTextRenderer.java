...
@ServeRenderer(renderKitId = "HTML_BASIC",
        ...
        rendererType = "org.omnifaces.serve.component.html.HtmlInputText")
public class HtmlInputTextRenderer extends HtmlOutputTextRenderer {
    ...
    public void decode(PhaseContext context, UIComponent component) {
        ...
        if (requestParameterMap.containsKey(id)) {
            ...
            evh.setSubmittedValue(requestParameterMap.get(id)[0]);
        }
    }
