...
/**
 * The HTML renderer for h:outputScript.
 */
@ServeRenderer(renderKitId = "HTML_BASIC",
        componentFamily = "org.omnifaces.serve.component.html",
        rendererType = "org.omnifaces.serve.component.html.HtmlOutputScript")
public class HtmlOutputScriptRenderer extends BaseRenderer {
