...
@ServeRenderer(renderKitId = "HTML_BASIC",
        ...
        rendererType = "org.omnifaces.serve.component.html.HtmlInputSecret")
public class HtmlInputSecretRenderer extends HtmlOutputTextRenderer {
    ...
    public void encode(PhaseContext context, UIComponent component) {
        ...
        if (rendered) {
            ...
            encodeAttribute(writer, "type", "password");
