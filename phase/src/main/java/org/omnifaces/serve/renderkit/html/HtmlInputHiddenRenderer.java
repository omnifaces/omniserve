...
/**
 * The HTML renderer for h:inputHidden.
 */
@ServeRenderer(renderKitId = "HTML_BASIC",
        componentFamily = "org.omnifaces.serve.component.html",
        rendererType = "org.omnifaces.serve.component.html.HtmlInputHidden")
public class HtmlInputHiddenRenderer extends HtmlOutputTextRenderer {
