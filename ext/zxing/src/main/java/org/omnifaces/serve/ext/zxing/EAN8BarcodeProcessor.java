...
/**
 * The processor for zxing:ean8Barcode.
 */
@TemplateProcessor(uri = "http://www.omnifaces.org/serve/ext/zxing", localName = "ean8Barcode")
public class EAN8BarcodeProcessor extends ServeTagProcessor {
    ...
    public void process(ServeProcessorContext context, UIComponent parent, int index) {
        ...
        HtmlEAN8Barcode component = createComponent(HtmlEAN8Barcode.class,
                "org.omnifaces.serve.ext.zxing.HtmlEAN8Barcode", context, parent, index);
