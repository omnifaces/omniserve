...
/**
 * The renderer for zxing:code128Barcode.
 */
@ServeRenderer(componentFamily = "org.omnifaces.serve.ext.zxing",
        rendererType = "org.omnifaces.serve.ext.zxing.HtmlCode128Barcode")
public class HtmlCode128BarcodeRenderer extends HtmlBarcodeRenderer {
    ...
    public void encode(PhaseContext context, UIComponent component) {
        HtmlCode128Barcode barcode = (HtmlCode128Barcode) component;
        ...
        src.append("?org.omnifaces.serve.ext.zxing.ZXingFilter.writerName=HtmlCode128Barcode&height=");
