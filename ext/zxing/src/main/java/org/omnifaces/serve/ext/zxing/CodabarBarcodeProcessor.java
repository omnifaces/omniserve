...
/**
 * The processor for zxing:codabarBarcode.
 */
@TemplateProcessor(uri = "http://www.omnifaces.org/serve/ext/zxing", localName = "codabarBarcode")
public class CodabarBarcodeProcessor extends ServeTagProcessor {
    ...
    public void process(ServeProcessorContext context, UIComponent parent, int index) {
        ...
        HtmlCodabarBarcode component = createComponent(HtmlCodabarBarcode.class,
                "org.omnifaces.serve.ext.zxing.HtmlCodabarBarcode", context, parent, index);
