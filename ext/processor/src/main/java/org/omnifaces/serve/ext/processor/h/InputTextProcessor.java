...
import org.omnifaces.serve.component.html.HtmlInputText;
import org.omnifaces.serve.ext.processor.ServeProcessorContext;
import org.omnifaces.serve.ext.processor.ServeTagProcessor;
import org.omnifaces.template.TemplateProcessor;

/**
 * The processor for h:inputText.
 */
@TemplateProcessor(uri = "http://www.omnifaces.org/serve/ext/h", localName = "inputText")
public class InputTextProcessor extends ServeTagProcessor {
    ...
    public void process(ServeProcessorContext context, UIComponent parent, int index) {
        ...
        HtmlInputText component = createComponent(HtmlInputText.class,
                "org.omnifaces.serve.component.html.HtmlInputText", context, parent, index);
