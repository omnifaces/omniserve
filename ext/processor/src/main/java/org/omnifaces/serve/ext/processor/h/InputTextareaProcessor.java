...
import org.omnifaces.serve.component.html.HtmlInputTextarea;
import org.omnifaces.serve.ext.processor.ServeProcessorContext;
import org.omnifaces.serve.ext.processor.ServeTagProcessor;
import org.omnifaces.template.TemplateProcessor;

/**
 * The processor for h:inputTextarea.
 */
@TemplateProcessor(uri = "http://www.omnifaces.org/serve/ext/h", localName = "inputTextarea")
public class InputTextareaProcessor extends ServeTagProcessor {
    ...
    public void process(ServeProcessorContext context, UIComponent parent, int index) {
        ...
        HtmlInputTextarea component = createComponent(HtmlInputTextarea.class,
                "org.omnifaces.serve.component.html.HtmlInputTextarea", context, parent, index);
        ...
        processValueExpressionAttribute(context, component, "cols", int.class);
