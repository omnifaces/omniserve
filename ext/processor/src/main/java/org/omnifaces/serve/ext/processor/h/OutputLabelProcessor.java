...
import org.omnifaces.serve.component.html.HtmlOutputLabel;
import org.omnifaces.serve.ext.processor.ServeProcessorContext;
import org.omnifaces.serve.ext.processor.ServeTagProcessor;
import org.omnifaces.template.TemplateProcessor;

/**
 * The processor for h:outputLabel.
 */
@TemplateProcessor(uri = "http://www.omnifaces.org/serve/ext/h", localName = "outputLabel")
public class OutputLabelProcessor extends ServeTagProcessor {
    ...
    public void process(ServeProcessorContext context, UIComponent parent, int index) {
        ...
        HtmlOutputLabel component = createComponent(HtmlOutputLabel.class,
                "org.omnifaces.serve.component.html.HtmlOutputLabel", context, parent, index);
