...
import org.omnifaces.serve.component.html.HtmlInputSecret;
import org.omnifaces.serve.ext.processor.ServeProcessorContext;
import org.omnifaces.serve.ext.processor.ServeTagProcessor;
import org.omnifaces.template.TemplateProcessor;

/**
 * The processor for h:inputSecret.
 */
@TemplateProcessor(uri = "http://www.omnifaces.org/serve/ext/h", localName = "inputSecret")
public class InputSecretProcessor extends ServeTagProcessor {
    ...
    public void process(ServeProcessorContext context, UIComponent parent, int index) {
        ...
        HtmlInputSecret component = createComponent(HtmlInputSecret.class,
                "org.omnifaces.serve.component.html.HtmlInputSecret", context, parent, index);
        ...
        processValueExpressionAttribute(context, component, "redisplay", boolean.class);
