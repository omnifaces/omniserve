...
import org.omnifaces.serve.component.html.HtmlCommandLink;
import org.omnifaces.serve.ext.processor.ServeProcessorContext;
import org.omnifaces.serve.ext.processor.ServeTagProcessor;
import org.omnifaces.template.TemplateProcessor;

/**
 * The processor for h:commandLink.
 */
@TemplateProcessor(uri = "http://www.omnifaces.org/serve/ext/h", localName = "commandLink")
public class CommandLinkProcessor extends ServeTagProcessor {
    ...
    public void process(ServeProcessorContext context, UIComponent parent, int index) {
        ...
        HtmlCommandLink component = createComponent(HtmlCommandLink.class,
                "org.omnifaces.serve.component.html.HtmlCommandLink", context, parent, index);
        ...
        super.process(context, component, index);
    }
}
