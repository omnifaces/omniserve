...
/**
 * The JUnit tests for InputCheckboxProcessor.
 */
public class InputCheckboxProcessorTest {
    ...
    public void testProcess() {
        ...
        InputCheckboxProcessor processor = new InputCheckboxProcessor();
        UIComponent parent = new UIPanel();
        processor.process(context, parent, 0);
        assertTrue(parent.getChildren().get(0) instanceof HtmlInputCheckbox);
    }
}
