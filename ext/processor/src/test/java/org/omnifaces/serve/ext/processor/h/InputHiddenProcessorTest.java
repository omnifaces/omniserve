...
/**
 * The JUnit tests for InputHiddenProcessor.
 */
public class InputHiddenProcessorTest {
    ...
    public void testProcess() {
        ...
        InputHiddenProcessor processor = new InputHiddenProcessor();
        UIComponent parent = new UIPanel();
        processor.process(context, parent, 0);
        assertTrue(parent.getChildren().get(0) instanceof HtmlInputHidden);
    }
}
