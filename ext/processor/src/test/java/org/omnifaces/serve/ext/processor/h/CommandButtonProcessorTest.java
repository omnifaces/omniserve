...
/**
 * The JUnit tests for CommandButtonProcessor.
 */
public class CommandButtonProcessorTest {
    ...
    public void testProcess() {
        ...
        CommandButtonProcessor processor = new CommandButtonProcessor();
        UIComponent parent = new UIPanel();
        processor.process(context, parent, 0);
        assertTrue(parent.getChildren().get(0) instanceof HtmlCommandButton);
    }
}
