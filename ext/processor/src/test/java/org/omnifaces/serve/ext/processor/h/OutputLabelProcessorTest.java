...
/**
 * The JUnit tests for OutputLabelProcessor.
 */
public class OutputLabelProcessorTest {
    ...
    public void testProcess() {
        ...
        OutputLabelProcessor processor = new OutputLabelProcessor();
        UIComponent parent = new UIPanel();
        processor.process(context, parent, 0);
        assertTrue(parent.getChildren().get(0) instanceof HtmlOutputLabel);
    }
}
