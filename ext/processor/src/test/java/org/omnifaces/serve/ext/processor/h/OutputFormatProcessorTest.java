...
/**
 * The JUnit tests for OutputFormatProcessor.
 */
public class OutputFormatProcessorTest {
    ...
    public void testProcess() {
        ...
        OutputFormatProcessor processor = new OutputFormatProcessor();
        UIComponent parent = new UIPanel();
        processor.process(context, parent, 0);
        assertTrue(parent.getChildren().get(0) instanceof HtmlOutputFormat);
    }
}
