...
/**
 * The JUnit tests for InputTextProcessor.
 */
public class InputTextProcessorTest {
    ...
    public void testProcess() {
        ...
        InputTextProcessor processor = new InputTextProcessor();
        UIComponent parent = new UIPanel();
        processor.process(context, parent, 0);
        assertTrue(parent.getChildren().get(0) instanceof HtmlInputText);
    }
}
