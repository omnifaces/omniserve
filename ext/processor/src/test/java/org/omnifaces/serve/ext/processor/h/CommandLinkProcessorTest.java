...
/**
 * The JUnit tests for CommandLinkProcessor.
 */
public class CommandLinkProcessorTest {
    ...
    public void testProcess() {
        ...
        CommandLinkProcessor processor = new CommandLinkProcessor();
        UIComponent parent = new UIPanel();
        processor.process(context, parent, 0);
        assertTrue(parent.getChildren().get(0) instanceof HtmlCommandLink);
    }
}
