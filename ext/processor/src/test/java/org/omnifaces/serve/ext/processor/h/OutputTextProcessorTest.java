...
/**
 * The JUnit tests for OutputTextProcessor.
 */
public class OutputTextProcessorTest {
    ...
    public void testProcess() {
        ...
        OutputTextProcessor processor = new OutputTextProcessor();
        UIComponent parent = new UIPanel();
        processor.process(context, parent, 0);
        assertTrue(parent.getChildren().get(0) instanceof HtmlOutputText);
    }
}
