...
/**
 * The JUnit tests for OutputLinkProcessor.
 */
public class OutputLinkProcessorTest {
    ...
    public void testProcess() {
        ...
        OutputLinkProcessor processor = new OutputLinkProcessor();
        UIComponent parent = new UIPanel();
        processor.process(context, parent, 0);
        assertTrue(parent.getChildren().get(0) instanceof HtmlOutputLink);
    }
}
