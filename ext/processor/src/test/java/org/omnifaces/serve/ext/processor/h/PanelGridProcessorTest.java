...
/**
 * The JUnit tests for PanelGridProcessor.
 */
public class PanelGridProcessorTest {
    ...
    public void testProcess() {
        ...
        PanelGridProcessor processor = new PanelGridProcessor();
        UIComponent parent = new UIPanel();
        processor.process(context, parent, 0);
        assertTrue(parent.getChildren().get(0) instanceof HtmlPanelGrid);
    }
}
