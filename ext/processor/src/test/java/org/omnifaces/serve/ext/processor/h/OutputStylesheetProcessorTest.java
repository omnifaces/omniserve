...
/**
 * The JUnit tests for OutputStylesheetProcessor.
 */
public class OutputStylesheetProcessorTest {
    ...
    public void testProcess() {
        ...
        OutputStylesheetProcessor processor = new OutputStylesheetProcessor();
