...
/**
 * The JUnit tests for InputSecretProcessor.
 */
public class InputSecretProcessorTest {
    ...
    public void testProcess() {
        ...
        InputSecretProcessor processor = new InputSecretProcessor();
        UIComponent parent = new UIPanel();
        processor.process(context, parent, 0);
        assertTrue(parent.getChildren().get(0) instanceof HtmlInputSecret);
    }
}
